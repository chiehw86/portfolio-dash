...
<div class="meta">報價時間:""" + Q["fetched_at_taipei"] + """ 台北時間 · 自動更新:週一至週五每半小時(:07 / :37),週六 07:07 補美債收盤 · 單位 USD 千元 · 紅漲綠跌 · 上市部位依隱含股數連動現價,基金/PE 為報表 NAV<span title="建置版本。貼上新的 build.yml 重跑之後這裡會跟著變;沒變就是還沒生效,或瀏覽器還在給快取(強制重新整理一次)。"> · 建置 """ + BUILD_TAG + " · " + _sig + """</span></div>
<nav id="topnav"></nav>
